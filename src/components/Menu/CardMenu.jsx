	...
	return (
		<div className='border border-solid border-1 border-stone-300 rounded-3xl'>
			<div className='flex justify-end'>
				<span className='absolute bg-yellow-400/80 text-xl w-20 mx-5 my-5 text-center rounded-3xl w-25 font-bold'>
					Details
				</span>
			</div>
			...
			<div className='mx-5 grid grid-flow-col grid-cols-2'>
				...
				<div className='my-auto flex justify-end'>
					<button className='h-10 w-25 text-4xl bg-gradient-to-r from-yellow-500/60 to-yellow-600/60 border-none rounded-3xl hover:scale-110 transition duration-300 ease-in-out cursor-pointer'>
